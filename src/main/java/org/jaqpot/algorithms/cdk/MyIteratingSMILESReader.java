 ...
 *
 * credits to @author Egon Willighagen &lt;egonw@sci.kun.nl&gt;
 * @cdk.created    2004-12-16
 *
 * @cdk.keyword    file format, SMILES
 */

public class MyIteratingSMILESReader extends DefaultIteratingChemObjectReader<IAtomContainer> {

    private BufferedReader           input;
    private static ILoggingTool logger           = LoggingToolFactory
            .createLoggingTool(MyIteratingSMILESReader.class);
     ...
     */
    public MyIteratingSMILESReader(Reader in, IChemObjectBuilder builder) {
     ...
     */
    public MyIteratingSMILESReader(InputStream in, IChemObjectBuilder builder) {
    ...
    public boolean hasNext() {
        if (!nextAvailableIsKnown) {
            ...
            try {
                ...
                nextMolecule.setProperty(CDKConstants.SMILES, line);
